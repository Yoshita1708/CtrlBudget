    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <?php if(isset($_SESSION['email']))
                    {
            ?>
                        <a class="navbar-brand" href="home.php">Ct&#8377l Budget</a>
            <?php
                    }
                    else
                    {
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav navbar-right">
                ...
                ?>
                    ...
                    <li><a href = "change-password.php"><span class = "glyphicon glyphicon-cog"></span>
                ...
                ?>
                    <li><a href="aboutus.php"><span class="glyphicon glyphicon-info-sign"></span>
                    About Us</a></li>
